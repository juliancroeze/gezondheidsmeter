...
<body class="min-h-screen bg-blue-50 font-sans">
    ...
    Gezondheidsmeter
            ...
            <div class="hidden md:flex space-x-4">
                <a href="login.php" class="bg-white text-blue-600 border border-blue-600 px-4 py-2 rounded-lg hover:bg-blue-50 transition flex items-center">
                    <i class="fas fa-lock mr-2"></i>
                    Login
                </a>
                <a href="register.php" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition flex items-center">
            ...
            <div id="mobile-menu" class="absolute top-full left-0 right-0 bg-white shadow-md md:hidden hidden">
                <div class="flex flex-col items-center py-4 space-y-4">
                    <a href="login.php" class="text-blue-600 border border-blue-600 px-6 py-3 rounded-lg hover:bg-blue-50 transition w-3/4 text-center flex items-center justify-center">
                        <i class="fas fa-lock mr-2"></i>
                        Login
                    </a>
...
<?php endif; ?>
            ...
            <div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="forgot-password.php" class="text-blue-600 hover:underline">Wachtwoord vergeten?</a>
                </div>
